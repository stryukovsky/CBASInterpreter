namespace CBASInterpreter.Interpreter;

using global::CBASInterpreter.Expressions;
using System;

public class StatementExpression : AbstractExpression
{
    private StatementExpression? _statement;
    private PrintExpression? _print;
    private InputExpression? _scan;
    ...
    public StatementExpression(StatementExpression? statement, InputExpression inputExpr)
    {
        _statement = statement;
        _scan = inputExpr;
    }
